...
![Papper dolls happy together. User in the middle, vendor and author either side](../img/2-1_01.png)
...
![Frog jumping between lilly pads. He has to go to the one in the middle to get to the one on the end](../img/2-1_02.png)
...
![Button reading button save](../img/2-1_03.png)
