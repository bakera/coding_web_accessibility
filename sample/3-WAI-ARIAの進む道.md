# Chapter 3 WAI-ARIAの進む道
WAI-ARIAの全体像について。HTML5の既存の要素のマークアップにパッチを当てるように記述することで、支援技術向けにもマークアップを拡張できるという基本思想とルールを解説します。

- [3-1 ARIA：平等への情熱](bodymatter_0_2.xhtml)
- [3-2 ロールプレイング](bodymatter_0_3.xhtml)
- [3-3 初めてのARIAウィジェット](bodymatter_0_4.xhtml)
- [3-4 ルールを知る](bodymatter_0_5.xhtml)
